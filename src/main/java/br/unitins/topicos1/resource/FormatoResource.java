...
public class FormatoResource {
    ...
    private static final Logger LOG = Logger.getLogger(FormatoResource.class);
    ...
    public Response getByDescricaoFormato(@PathParam("descricaoFormato") String descricao){
        LOG.infof("Executando o metodo getByDescricaoFormato. descricaoFormato: %s", descricao);
